...
urlpatterns = patterns('',
    ...
    url(r'^plan/(?P<plan_id>\d+)/runs/$', view='tcms.apps.testruns.views.load_runs_of_one_plan',
        name='load_runs_of_one_plan_url'),
    url(r'^plan/(?P<plan_id>\d+)/$', view='tcms.apps.testplans.views.get',
        name='test_plan_url'),
    url(r'^plan/(?P<plan_id>\d+)/(?P<slug>[-\w\d]+)$', view='tcms.apps.testplans.views.get',
        name='test_plan_url'),
    ...
    (r'^cases/load-more/$', 'tcms.apps.testcases.views.load_more_cases'),
