...
from models import Classification, Product, Priority, Milestone, Component, Version
from models import TestBuild, TestEnvironment, TestAttachment, TestTag
...
# admin.site.register(TestAttachment, AttachmentAdmin)
