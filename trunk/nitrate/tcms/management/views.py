...
def environment_groups(request, template_name = 'environment/groups.html'):
    ...
    Environements list
    """
    from tcms.management.models import TCMSEnvGroup, TCMSEnvGroupPropertyMap
...
def environment_group_edit(request, template_name = 'environment/group_edit.html'):
    ...
    """
    from tcms.management.models import TCMSEnvGroup, TCMSEnvProperty, TCMSEnvGroupPropertyMap
...
def environment_properties(request, template_name = 'environment/property.html'):
    ...
    """
    from tcms.management.models import TCMSEnvProperty, TCMSEnvGroupPropertyMap
...
def environment_property_values(request, template_name = 'environment/ajax/property_values.html'):
    ...
    """
    from tcms.management.models import TCMSEnvProperty, TCMSEnvValue
    message = ''
